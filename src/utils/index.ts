export const SRC_BASE_URL = 'https://mangafire.to';
export const SRC_HOME_URL = 'https://mangafire.to/home';
export const USER_AGENT_HEADER = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36';
